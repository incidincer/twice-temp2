...
public class CursorXY {
	...
	public CursorXY(String user, int x, int y, long timeStamp, int blobNumber) {
		...
		this.blobNumber = blobNumber; //added by Inci
	}
	...
	public int getblobNumber() {  //added by Inci
		return blobNumber;}
	
	public void setblobNumber(int num) {  //added by Inci
		this.blobNumber = num;
	}
