...
public class ProxyBody {
	...
	public void initialize() {
		...
		/* logging */
		// if (! Window.Location.getHref().contains("assets.adobedtm.com") &&
		// !Window.Location.getHref().isEmpty()){
		// String log = "**** U: "+Window.Navigator.getUserAgent() +
		// " Page: "+Window.getTitle() + "URL: " +Window.Location.getHref() +
		// " T: "+ System.currentTimeMillis();
		//
		// //Window.alert("u: "+Window.Navigator.getUserAgent() +
		// " L: "+Window.Location.getHref()); //+ System.currentTimeMillis()
		// log(log);
		// }
		...
		Event.addNativePreviewHandler(new NativePreviewHandler() {
			...
			/**
			 * Rewrites the URLs on mouse down if somebody clicks on an anchor
			 * element
			 * 
	...
	/**
	 * If something in the DOM has changed, call the different handlers and
	 * replace the standard widgets
	 * 
	 * @param evt
	 */
	...
	private void log(String result) {
		...
		LogServiceAsync svc = GWT.create(LogService.class);
		svc.log(result, new AsyncCallback<Void>() {
